...
fun Soal_1110() {
    ...
    // Tingkat 1 Level 1 Soal 10

    arr_soal += "رَوَاهُ البُخَارِيُّ وَمُسْلِمٌ."
    arr_soal += "تَعَالىَ"
    arr_soal += "اللهِ"
    arr_soal += "عَلَى" // Yang ini (44)
    ...
    val soal_1110 : HalamanSoal = HalamanSoal("Soal 1 - 10", 1, arr_soal.reversedArray(), arr_lokasi, pertanyaan, opsi_1, opsi_2, opsi_3, opsi_4, opsi_benar, rute_berikutnya, soal_ke)
    Soal_11.add(soal_1110)
}