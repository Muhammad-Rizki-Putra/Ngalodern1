...
fun Soal_1103() {
    ...
    rute_berikutnya = "Soal1_1_3"
    soal_ke = "3/10"

    val soal_1103 : HalamanSoal = HalamanSoal("Soal 1 - 3", 1, arr_soal.reversedArray(), arr_lokasi, pertanyaan, opsi_1, opsi_2, opsi_3, opsi_4, opsi_benar, rute_berikutnya, soal_ke)
    Soal_11.add(soal_1103)
}