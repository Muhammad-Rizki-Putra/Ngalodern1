...
fun Soal_1107() {
    ...
    val soal_1107 : HalamanSoal = HalamanSoal("Soal 1 - 7", 1, arr_soal.reversedArray(), arr_lokasi, pertanyaan, opsi_1, opsi_2, opsi_3, opsi_4, opsi_benar, rute_berikutnya, soal_ke)
    Soal_11.add(soal_1107)
}