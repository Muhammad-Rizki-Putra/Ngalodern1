...
fun Soal_1109() {
    ...
    arr_soal += "بِحَقِّ"
    arr_soal += "إِلاَّ"
    arr_soal += "وَأَمْوَالَـهُمْ" // Yang ini (39)
    ...
    rute_berikutnya = "Soal1_1_9"
    soal_ke = "9/10"

    val soal_1109 : HalamanSoal = HalamanSoal("Soal 1 - 9", 1, arr_soal.reversedArray(), arr_lokasi, pertanyaan, opsi_1, opsi_2, opsi_3, opsi_4, opsi_benar, rute_berikutnya, soal_ke)
    Soal_11.add(soal_1109)
}