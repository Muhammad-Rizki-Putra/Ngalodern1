...
fun Data1_1_9S() {
    ...
    val soal1_1_9 : HalamanSoal = HalamanSoal("Soal 1 - 9", 1, arr_soal.reversedArray(), arr_lokasi, pertanyaan, opsi_1, opsi_2, opsi_3, opsi_4, opsi_benar, rute_berikutnya, soal_ke)
    Soal.add(soal1_1_9)
}