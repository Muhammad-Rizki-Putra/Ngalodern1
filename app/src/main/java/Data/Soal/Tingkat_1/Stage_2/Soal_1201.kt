...
fun Soal_1201() {
    ...
    val soal_1201 : HalamanSoal = HalamanSoal("Soal 2 - 1", 2, arr_soal.reversedArray(), arr_lokasi, pertanyaan, opsi_1, opsi_2, opsi_3, opsi_4, opsi_benar, rute_berikutnya, soal_ke)
    Soal_12.add(soal_1201)
}