...
fun Soal_2205() {
    ...
    val soal_2205 : HalamanSoal = HalamanSoal("Soal 2 - 5", 1, arr_soal.reversedArray(), arr_lokasi, pertanyaan, opsi_1, opsi_2, opsi_3, opsi_4, opsi_benar, rute_berikutnya, soal_ke)
