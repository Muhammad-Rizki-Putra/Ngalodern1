...
//    Array_Duplicate += Pair(16,iterasi - 1)
    ...
    val video4 = HalamanMateri("Kalimat", "", resultArray ,Array_indo.reversedArray(), Array_arab.reversedArray(), Array_logat,  ArtiFull , Array_logat_B, Array_Duplicate ,Penjelasan)
    Video.add(video4)
}